...
import com.admin.testinnsightapp.databinding.ActivityMovielistBinding
import com.admin.testinnsightapp.adapter.CustomAdapterMovies
import com.admin.testinnsightapp.utils.*
import com.admin.testinnsightapp.viewmodel.*
                        ...
                        override fun onItemClick(view: View, position: Int) {
                            if (customAdapterMovies.getData().isNotEmpty()) {
                                ...
                                searchItem?.let {
                                    ...
                                    intent.putExtra(AppConstant.INTENT_IMBDID, it.imdbID)
